...
For information on how to manage VLANs from the Gateway Appliances Details screen, refer to [Managing VLANs](/docs/virtual-router-appliance?topic=virtual-router-appliance-managing-your-vlans).
