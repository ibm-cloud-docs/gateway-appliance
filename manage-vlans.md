...
You can perform a variety of actions from the [Gateway Appliance Details screen](/docs/gateway-appliance?topic=gateway-appliance-viewing-gateway-appliance-details).
{: shortdesc}
